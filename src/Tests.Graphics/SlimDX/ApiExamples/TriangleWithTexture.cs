        ...
        public void Run()
        {
            using (var form = EmptyWindow.CreateForm())
            {
                ...
                foreach (var vertex in vertices)
                {
                    ...
                    stream.Write(vertex.TextureCoord);
                }
                ...
                Texture2D texture2D = Texture2D.FromFile(device, "texture.png");
                ...
                Application.Idle +=
                   delegate
                   {
                       ...
                       effect.GetVariableByName("MyTexture").AsResource().SetResource(shaderResourceView);
